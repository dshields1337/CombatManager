...
- [ ] Combat screen. (Sequence/Party/Monsters sub-tabs, persistent active/inactive party composition, monster mini labels, monster-only encounters, inline HP editing/steppers, health-band feedback, natural and total initiative display, ready/in-combat lifecycle, drag-reorderable turn order, named saves with switch protection, participant actions, notes, conditions, and turn/round tracking are complete; broader legacy condition effects remain.)
