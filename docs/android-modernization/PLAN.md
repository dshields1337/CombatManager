...
- [ ] Add focused tests for calculations, serialization, database queries, and import/export parsing. (31 utility/value/dice/attack/affliction/initiative/read-only-data/combat-roster tests added; broader database/import tests remain.)
...
- [ ] Combat screen. (Monster and manual participant entry, duplicate naming, damage/healing, defeated state, initiative ordering, active-turn navigation, round tracking, private encounter persistence, individual removal, and confirmed clear are complete; manual editing and deeper conditions remain.)
