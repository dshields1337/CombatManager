...
- [ ] Combat screen. (Named encounters, monster/manual entry, grouped participant actions, duplication/editing, damage/healing/full/temporary HP controls, notes, editable timed/untimed conditions with turn expiry, 34-entry presets/rules and bulk clearing, individual/bulk/automatic monster initiative, turn/round tracking, persistence, confirmed removal, and confirmed clear are complete; broader legacy condition effects remain.)
