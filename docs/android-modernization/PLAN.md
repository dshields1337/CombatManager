...
- [ ] Add focused tests for calculations, serialization, database queries, and import/export parsing. (35 utility/value/dice/attack/affliction/initiative/read-only-data/combat-roster tests added; broader database/import tests remain.)
