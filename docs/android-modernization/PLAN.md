...
- [ ] Combat screen. (Monster/manual entry, grouped participant actions, duplication/editing, HP controls, notes, timed conditions with turn expiry, individual/bulk initiative, turn/round tracking, persistence, confirmed removal, and confirmed clear are complete; broader condition catalogue remains.)
