...
- [ ] Combat screen. (Monster/manual entry, grouped participant actions, duplication/editing, HP controls, notes, timed conditions with turn expiry and a 34-entry preset catalogue, individual/bulk initiative, turn/round tracking, persistence, confirmed removal, and confirmed clear are complete; condition rules integration remains.)
