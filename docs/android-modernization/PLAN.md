...
- [ ] Combat screen. (Named saved encounters with save-before-switch protection, saved/temporary manual entry with editable initiative modifiers, direct monster/character full-details access, grouped participant actions, duplication/editing, damage/healing/full/temporary HP controls, notes, editable timed/untimed conditions with turn expiry, 34-entry presets/rules and bulk clearing, individual/bulk/automatic all-combatant initiative, turn/round tracking, persistence, confirmed removal, and confirmed clear are complete; broader legacy condition effects remain.)
