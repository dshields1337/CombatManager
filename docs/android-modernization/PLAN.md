...
- [ ] Add the required `CombatManagerCore` source to the modern core project.
...
- [ ] Add focused tests for calculations, serialization, database queries, and import/export parsing.
